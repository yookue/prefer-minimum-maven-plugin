...
Unikue prefer-minimum-maven-plugin is a maven plugin, to filter resources, using minimum files instead of original ones.
...
- Github: https://github.com/unikueltd/prefer-minimum-maven-plugin
